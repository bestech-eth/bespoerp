...
class MoceanVoiceCallLogs_Setting extends MoceanBaseSettingController
{
	...
	{
		$db_obj = new MoceanVoiceCallDatabase($this->db);
...
?>
		...
		<div class="bootstrap-wrapper">
			...
			?>
				...
				?></td>
				<td><?php echo ($result['status'] == 0 ? "success" : "failed"); ?></td>
				</tr>
				<?php } ?>
			</tbody>

...
class SMS_Contact_Setting extends MoceanBaseSettingController
{
	...
	private function get_default_settings()
	{
		$settings = array(
			...
			"sms_templates" => array(
				...
				"enabledisabled" => "Hi, your acc has been [acc_status]",
			),
		);
	...
	public function contactEnableDisable(Contact $object)
	{
		...
		$result = moceanapi_send_sms($from, $to, $message, "Automation");
	}

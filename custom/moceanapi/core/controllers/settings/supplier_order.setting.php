...
class SMS_SupplierOrder_Setting extends MoceanBaseSettingController
{
	...
	public $db_key = "MOCEANAPI_SUPPLIER_ORDER_SETTING";
	...
	private function get_default_settings()
	{
		$settings = array(
			...
			"sms_templates" => array(
				...
				"validated" 	=> "Hi [company_name], your purchase order ([ref]) of [total_ttc] is validated.",
				"approved"   	=> "Hi [company_name], here's our purchase order ([ref]) of [total_ttc]. We will be expecting delivery on [delivery_date]",
				"refused"   	=> "Hi [company_name], we are not able to proceed with purchase order ([ref]).",
				"dispatched"    => "Hi [company_name], thank you for your payment, your invoice ([ref]) is paid.",
			),
		);
	...
	public function trigger_sms(CommandeFournisseur $object, $action)
	{
		...
		$this->log->add("MoceanAPI", "SMS Successfully sent from fx trigger_sms");
	}

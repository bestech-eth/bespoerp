...
print '<a alt="Official portal of your ERP CRM application" targe="_blank" href="https://www.bespo.et?utm_medium=website&utm_source=demo"><img class="demologo" src="'.DOL_URL_ROOT.'/theme/dolibarr_logo.svg" alt="Dolibarr logo"></a>';
print '</div>';
print '</div>';
